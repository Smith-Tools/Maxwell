...
├── patterns/
│   ├── AGENTS-DECISION-TREES.md         # Architectural decision frameworks with quantitative criteria
│   └── AGENTS-AGNOSTIC.md               # Universal principles and foundational patterns
├── pointfree/                            # Point-Free ecosystem coordination patterns
│   ├── decision-trees/                  # Framework selection decision trees
│   ├── examples/                       # Integration examples and patterns
│   ├── integration/                    # Cross-framework coordination
│   ├── routing/                        # Framework detection and routing patterns
│   ├── resources/                      # Validation tools and references
│   └── validation/                    # Architectural validation rules and anti-patterns
└── case-studies/                           # Real-world architectural case studies
...
→ Provides quantitative criteria (line count, action count, complexity metrics) and recommendation
```

### **Framework Selection**
```
User: "Should I use @DependencyClient or singleton for my API client?"
→ Provides decision tree with performance, maintainability, and scalability considerations
```

### **Module Boundary Design**
```
User: "What are the best practices for module boundaries in my Swift project?"
→ Provides comprehensive guidelines for clean separation with explicit interfaces
```

### **Production Validation**
```
User: "How do I validate my architecture for production deployment?"
→ Provides automated compliance checking and validation frameworks
```

### **Troubleshooting Support**
```
User: "My architecture has circular dependencies - what should I do?"
→ Provides case studies and anti-pattern solutions for common architectural problems
```
