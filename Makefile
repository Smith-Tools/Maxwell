...
test:
	...
	@[ -d "$(LOCAL_SKILL_DIR)/maxwell-tca" ] && echo "   ✅ skill-tca structure valid"
	@[ -f "$(LOCAL_SKILL_DIR)/maxwell-tca/SKILL.md" ] && echo "   ✅ skill-tca manifest valid"
	...
	@[ -d "$(LOCAL_SKILL_DIR)/maxwell" ] && echo "   ✅ skill-maxwell structure valid"
	@[ -f "$(LOCAL_SKILL_DIR)/maxwell/SKILL.md" ] && echo "   ✅ skill-maxwell manifest valid"
