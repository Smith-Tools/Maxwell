...
/// Simple script to insert patterns into Maxwell database
/// This script adds key TCA patterns extracted from the documentation

let dbPath = "/Volumes/Plutonian/_Developer/Smith Tools/Maxwell/database/maxwell.db"

do {
    print("🚀 Initializing Maxwell database...")
    let database = try SimpleDatabase(databasePath: dbPath)

    print("📝 Adding TCA @Shared patterns...")

    // Pattern 1: @Shared In-Memory Sharing
...
""",
    ...
    print("✅ Added: @Shared In-Memory Sharing")

    // Pattern 2: @Shared Reference Passing
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: @Shared Reference Passing")

    // Pattern 3: @Shared UserDefaults
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: @Shared UserDefaults Persistence")

    // Pattern 4: @Shared File Storage
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: @Shared File Storage Persistence")

    // Pattern 5: Stack-Based Navigation
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: Stack-Based Navigation")

    // Pattern 6: TestStore @Shared Testing
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: TestStore @Shared Testing")

    // Pattern 7: @Shared Single Owner
    try database.insertPattern(
...
""",
    ...
    print("✅ Added: @Shared Single Owner Pattern")

    print("\\n📊 Successfully added 7 TCA patterns to Maxwell database!")
    print("\\n🔍 You can now test pattern search:")
    print("   swift search-patterns.swift \"@Shared\"")
    print("   swift search-patterns.swift \"navigation\"")

} catch {
    print("❌ Error adding patterns: \\(error)")
    print("Make sure the database exists at: \\(dbPath)")
}