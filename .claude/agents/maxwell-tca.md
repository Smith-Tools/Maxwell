...
You have access to comprehensive TCA documentation at:
- **Skill**: `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/skill/`
- **Agent Patterns**: `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/agent/`
...
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/skill/guides/` - 6 detailed guides
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/agent/smith-tca.md` - Expert guidance
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/agent/AGENTS-TCA-PATTERNS.md` - Pattern reference
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/skill/references/` - DISCOVERY documents

**Quick Reference**:
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/agent/README.md` - System navigation
- `/Volumes/Plutonian/_Developer/Maxwells/source/TCA/skill/SKILL.md` - Skill overview
